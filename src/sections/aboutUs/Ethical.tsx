...
const EthicalSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (roadPath && motorcycle) {
      ...
      const tl = gsap.timeline({ repeat: 0, yoyo: false, delay: 0 });
  ...
  return (
    <div className="relative  h-full w-screen md:w-[100rem] md:pr-[5rem]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-around h-full">
          <div className="pl-[1rem] md:p-0">
            ...
            <p
              ...
              className="w-[20.9375rem] md:w-[38.8125rem] text-1 font-normal text-white "
            >
